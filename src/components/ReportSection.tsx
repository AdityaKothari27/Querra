          ...
          <div className="border-t border-gray-200 dark:border-gray-700 p-4">
            ...
            <div className="flex space-x-2 items-end">
              <textarea
                ...
                className="flex-1 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 overflow-y-auto"
              />
              <button
